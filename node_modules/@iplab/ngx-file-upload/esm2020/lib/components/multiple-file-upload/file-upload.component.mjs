...
import * as i4 from "../drop-zone/file-upload-drop-zone.component";
...
FileUploadComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0", ngImport: i0, type: FileUploadComponent, deps: [{ token: i1.FileUploadService }, { token: i0.ElementRef }, { token: i0.Renderer2 }, { token: DOCUMENT }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component });
FileUploadComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.0.0", type: FileUploadComponent, selector: "file-upload:not([simple])", inputs: { control: "control", animation: "animation", multiple: "multiple" }, host: { listeners: { "drop": "onDrop($event)" }, properties: { "class.has-files": "this.hasFiles", "class.ng-invalid": "this.isInvalid", "@.disabled": "this.isAnimationDisabled" } }, providers: [
        FileUploadService,
        {
