...
@Component({
  ...
  imports: [CommonModule, 
    ...
    FormsModule],
  templateUrl: './instance-launch.component.html',
  styleUrls: ['./instance-launch.component.css']
})
export class InstanceLaunchComponent implements OnInit, OnDestroy
{
