...
@Component({
  ...
  imports: [CommonModule, 
    ...
    FormsModule],
  templateUrl: './instant-list.component.html',
  styleUrls: ['./instant-list.component.css']
})
export class InstantListComponent implements OnInit, OnDestroy
{
