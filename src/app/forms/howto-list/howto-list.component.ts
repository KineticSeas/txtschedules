...
import { AddHowtoFormComponent } from '../add-howto-form/add-howto-form.component';

@Component({
  selector: 'app-howto-list',
  standalone: true,
  imports: [CommonModule, 
    Ng2SearchPipeModule, RouterModule, SitebarWrapperComponent, AddProjectComponent, AddHowtoFormComponent, 
