...
export class NewSignupComponent  implements OnInit {
  ...
  constructor(
    ...
    postForm() {
      this._dataService.postForm("post-add-project", this.data.formData).subscribe((data:any)=>{
    ...
    getForm() {
      ...
      this._dataService.postForm("get-add-project-form", formData).subscribe((data:any)=>{
        this.data=data;
       });
    }
}
