...
export class AddProductComponent implements OnInit {
  ...
  constructor(
    ...
    postForm() {
      this._dataService.postForm("post-add-product", this.data.formData).subscribe((data:any)=>{
    ...
    getForm() {
      ...
      this._dataService.postForm("get-add-product-form", formData).subscribe((data:any)=>{
        this.data=data;
       });
    }
}
